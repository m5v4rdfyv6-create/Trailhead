const CACHE='trailhead-expedition-v2';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./pine-bg.jpg','./desert-bg.jpg','./coast-bg.jpg','./alpine-bg.jpg','./autumn-bg.jpg','./night-bg.jpg'];
